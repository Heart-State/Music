...
define(['./workbox-8d84a2d1'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.kst9gr26hp8"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/someInterface/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/(.*?)\.(js|css|ts|html)/, new workbox.StaleWhileRevalidate({
